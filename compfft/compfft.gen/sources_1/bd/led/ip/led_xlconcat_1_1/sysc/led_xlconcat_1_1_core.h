...
#ifndef _led_xlconcat_1_1_core_h_
#define _led_xlconcat_1_1_core_h_
...
class led_xlconcat_1_1_core : public sc_module 
{
    public: 
       led_xlconcat_1_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(led_xlconcat_1_1_core);
    ...
    virtual ~led_xlconcat_1_1_core() = default;
